...
def dasboardPage(app):
    ...
    frButtonProgress.config(width = 50)
    ...
    '''frButtonOptions = app.buttons(frMenu, "Configuración")
    frButtonOptions.config(width = 50, command = lambda:options_page.optionsPage(app))
    frButtonOptions.pack(pady = 5)'''